...
bool TransformBuffer::interpolateTransform(const geometry_msgs::msg::TransformStamped& tf_earlier, const geometry_msgs::msg::TransformStamped& tf_later,
  ...
  // tf2::fromMsg(tf_earlier.transform.translation, tf_earlier_translation); // not available on foxy?
  tf_earlier_translation = tf2::Vector3(tf_earlier.transform.translation.x,
    tf_earlier.transform.translation.y, tf_earlier.transform.translation.z);
  //
